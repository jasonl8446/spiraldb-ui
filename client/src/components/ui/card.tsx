...
/**
 * Card primitive — vendored from shadcn/ui (task 1.8 decision D39).
 *
 * Spec surface: `rounded-lg` (8px), `zinc-900` panel, `zinc-800` border,
 * `p-5` card padding and a `zinc-50` semibold title
 * (docs/spec-ui-design.md L26-42).
 */
